...
actualizarTop('mediano', JSON.parse(localStorage.getItem("lista8")));///jhk,unimyjhuynkmi,
...
//SOBRE ESCRIBE LOS NOMBRES DE LOS RANKINGS DE DIFICULTADES *facil mediano dificil*
//NO MOSTRAR O SACAR LOS MAXIMOS